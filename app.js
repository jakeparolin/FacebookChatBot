...
function handleMessage(sender_psid, received_message) {
    ...
    if (received_message.text) {
        ...
        switch(message) {
            ...
            case "help":
                response = {"text": "Here's a list of my commands: type 'joke' and I will send you something funny. type 'weather' and I will update you with the current weather. Type 'quote' for a random quote from someone famous! You can also upload an image into the chat and then share it with a friend!"}
                break;
