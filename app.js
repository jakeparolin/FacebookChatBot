  ...
  if (received_message.text) {
    ...
    switch (message) {
      ...
      case "help":
        response = {
          text:
            "Here's a list of my commands: type 'joke' and I will send you something funny. type 'weather' and I will update you with the current weather. Type 'quote' for a random quote from someone famous! You can also upload an image into the chat and then share it with a friend!"
        };
        break;
      ...
      default:
        response = {
          text:
            "I'm sorry, I'm still learning and don't quite understand. type 'help' for a list of my commands"
        };
    }
  ...
  request(
    ...
    (err, res, body) => {
      if (!err) {
        ...
        response = {
          text: `Hello, ${name}. I am Dolores. Type 'help' for a list of commands`
        };
        callSendAPI(sender_psid, response);
      } else {
  ...
  request(
    ...
    (err, res, body) => {
      if (!err) {
        ...
        response = {
          text: `Here is your weather update for ${name}. The current temperature is ${temp} degrees with a high of ${high} and a low of ${low}. Humidty is at ${humidity}% with wind speeds at ${wind}mph`
        };
        callSendAPI(sender_psid, response);
      } else {
